...
df_landerpapiere <- scrape_OWID("share-elec-by-source", df_landerpapiere) |> 
          left_join(scrape_OWID("per-capita-ghg-emissions", df_landerpapiere)[, c("Per-capita", "iso3c")], by = "iso3c") |> 
          ...
          left_join(scrape_OWID("refugee-population-by-country-or-territory-of-asylum", df_landerpapiere)[, c("Refugee", "iso3c")], by = "iso3c") |>
