...
\newcommand{\checkCity}{%
    \ifdefined\city%
        \ifthenelse{\equal{\city}{Bayreuth}}{%
            ...
            \newcommand{\office}{Mitglied des Bundestags}%
            \newcommand{\evpleader}{Marco}%
            \newcommand{\sdleader}{Franz}%
            \newcommand{\releader}{Lea}%
            \newcommand{\greenleader}{Linus}%
            \newcommand{\idleader}{Yannick}%
            \newcommand{\evproom}{WIRD NOCH EINGEFÜGT}%
            \newcommand{\sdroom}{WIRD NOCH EINGEFÜGT}%
            \newcommand{\reroom}{WIRD NOCH EINGEFÜGT}%
            \newcommand{\greenroom}{WIRD NOCH EINGEFÜGT}%
            \newcommand{\idroom}{WIRD NOCH EINGEFÜGT}%
            \newcommand{\picPolitiker}{Bilder/hacker.png}%
            \date{17. Mai 2024}%
        }{%
            ...
            \newcommand{\office}{Mitglied des Bundestags}%
            \newcommand{\evpleader}{Franz}%
            \newcommand{\sdleader}{Christoph}%
            \newcommand{\releader}{Lea}%
            \newcommand{\greenleader}{Vanessa}%
            \newcommand{\idleader}{Yannick}%
            \newcommand{\evproom}{H136}%
            \newcommand{\sdroom}{H137}%
            \newcommand{\reroom}{H121}%
            \newcommand{\greenroom}{H138}%
            \newcommand{\idroom}{H123}%
            \newcommand{\picPolitiker}{Bilder/silberhorn.png}%
            \date{16. Mai 2024}%
        }%
    \fi%
}
...
\newcommand{\thema}{Green Deal}
%\newcommand{\thema}{Migration}
%\newcommand{\thema}{Armee}

\newcommand{\Fraktion}{LEER} % AUF KEINEN FALL ÄNDERN



\newcommand{\checkTopic}{%
    \ifdefined\thema%
        \ifthenelse{\equal{\thema}{Green Deal}}{%
            ...
            \ifthenelse{\equal{\thema}{Migration}}{%
                \newcommand{\ausschuesse}{%
                    \begin{enumerate}
...
\vspace{-1cm}
    \begin{center}
        \includegraphics[height=4cm]{\picPolitiker}
    \end{center}
\end{frame}
